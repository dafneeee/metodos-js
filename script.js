...
document.write('<h3>Desafio Anterior: Numero de Atenciones</h3> ');

document.write("Cantidad de atenciones para radiologia: " + "<span>" + radiologia.length + "</span>" + "<br>") //concatenar oldschool
document.write(`Cantidad de atenciones para traumatologia:  ${traumatologia.length} <br>`) //concatenar con ES6
document.write(`Cantidad de atenciones para dental:   ${dental.length} <br>`)


document.write(`Primera Atencion: ${radiologia[0].paciente} - ${radiologia[0].rut} - ${radiologia[4].prevision}  | Última atención: ${radiologia[4].paciente} - ${radiologia[4].rut} - ${radiologia[4].prevision}` );
